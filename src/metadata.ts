export default async () => {
    const t = {
        './modules/user/entities/access-token.entity': await import(
            './modules/user/entities/access-token.entity'
        ),
        ...
        './modules/content/entities/post.entity': await import(
            './modules/content/entities/post.entity'
        ),
        './modules/content/entities/comment.entity': await import(
            './modules/content/entities/comment.entity'
        ),
        './modules/user/entities/refresh-token.entity': await import(
            './modules/user/entities/refresh-token.entity'
        ),
        './modules/content/constants': await import('./modules/content/constants'),
        './modules/content/entities/category.entity': await import(
            './modules/content/entities/category.entity'
        ),
        './modules/content/entities/tag.entity': await import(
            './modules/content/entities/tag.entity'
        ),
    ...
    return {
        '@nestjs/swagger': {
            models: [
                [
                    import('./modules/user/entities/refresh-token.entity'),
                    {
                        RefreshTokenEntity: {
                            accessToken: {
                                required: true,
                                type: () =>
                                    t['./modules/user/entities/access-token.entity']
                                        .AccessTokenEntity,
                                description: '\u5173\u8054\u7684\u767B\u5F55\u4EE4\u724C',
                            },
                        },
                ...
                [
                    import('./modules/rbac/entities/role.entity'),
                    {
                        RoleEntity: {
                            ...
                            systemed: { required: false, type: () => Boolean },
                    ...
                    import('./modules/user/entities/user.entity'),
                    {
                        UserEntity: {
                            ...
                            posts: {
                                required: true,
                                type: () => [
                                    t['./modules/content/entities/post.entity'].PostEntity,
                                ],
                            },
                            comments: {
                                required: true,
                ...
                [
                    import('./modules/user/entities/access-token.entity'),
                    {
                        AccessTokenEntity: {
                            refreshToken: {
                                required: true,
                                type: () =>
                                    t['./modules/user/entities/refresh-token.entity']
                                        .RefreshTokenEntity,
                            },
                            user: {
                                required: true,
                ...
                [
                    import('./modules/content/entities/comment.entity'),
                    {
                        CommentEntity: {
                            ...
                            createdAt: { required: true, type: () => Date },
                            depth: { required: true, type: () => Object, default: 0 },
                            parent: {
                                required: true,
                                type: () =>
                                    t['./modules/content/entities/comment.entity'].CommentEntity,
                ...
                [
                    import('./modules/content/entities/tag.entity'),
                    {
                        TagEntity: {
                            id: { required: true, type: () => String },
                            name: { required: true, type: () => String },
                ...
                [
                    import('./modules/content/entities/post.entity'),
                    {
                        PostEntity: {
                            id: { required: true, type: () => String },
                            ...
                            type: {
                                required: true,
                                enum: t['./modules/content/constants'].PostBodyType,
                            },
                            publishedAt: { required: false, type: () => Date, nullable: true },
                            customOrder: { required: true, type: () => Number },
                            createdAt: { required: true, type: () => Date },
                            updatedAt: { required: true, type: () => Date },
                            deletedAt: { required: true, type: () => Date },
                            commentCount: {
                ...
                [
                    import('./modules/content/entities/category.entity'),
                    {
                        CategoryEntity: {
                            id: { required: true, type: () => String },
                            name: { required: true, type: () => String },
                ...
                [
                    import('./modules/restful/dtos/delete.dto'),
                    {
                        DeleteDto: {
                            ids: {
                                required: true,
                                type: () => [String],
                                description: '\u5F85\u5220\u9664\u6570\u636E\u7684ID\u5217\u8868',
                            },
                        },
                    },
                ],
                [
                    import('./modules/restful/dtos/delete-with-trash.dto'),
                    {
                        DeleteWithTrashDto: {
                            trash: {
                                required: false,
                        ...
                        RestoreDto: {
                            ids: {
                                required: true,
                                type: () => [String],
                                description: '\u5F85\u6062\u590D\u6570\u636E\u7684ID\u5217\u8868',
                            },
                        },
                    },
                ],
                [
                    import('./modules/restful/dtos/paginate.dto'),
                    {
                        PaginateDto: {
                            page: {
                                required: false,
                ...
                [
                    import('./modules/restful/dtos/paginate-width-trashed.dto'),
                    {
                        PaginateWithTrashedDto: {
                            trashed: {
                                required: false,
                                description:
                                    '\u6839\u636E\u8F6F\u5220\u9664\u72B6\u6001\u67E5\u8BE2',
                                enum: t['./modules/database/constants'].SelectTrashMode,
                            },
                        },
                    },
                ],
                [
                    import('./modules/user/dtos/common.dto'),
                    {
                        UserCommonDto: {
                            credential: {
                                required: true,
                ...
                [import('./modules/user/dtos/auth.dto'), { CredentialDto: {}, RegisterDto: {} }],
                [
                    import('./modules/user/dtos/user.dto'),
                    {
                        ...
                        QueryUserDto: {
                            ...
                            orderBy: {
                                ...
                                enum: t['./modules/user/constants'].UserOrderType,
                            },
                        },
                        QueryFrontendUserDto: {},
                    },
                ],
                [
                    import('./modules/user/dtos/account.dto'),
                    {
                        UpdateAccountDto: {},
                        UpdatePasswordDto: {
                            oldPassword: {
                ...
                [
                    ...
                    {
                        QueryRoleDto: { user: { required: false, type: () => String } },
                        CreateRoleDto: {
                            name: {
                                required: true,
                                type: () => String,
                ...
                [
                    import('./modules/content/dtos/category.dto'),
                    {
                ...
                [
                    import('./modules/content/dtos/post.dto'),
                    {
                        QueryPostDto: {
                            search: {
                                required: false,
                            ...
                            orderBy: {
                                ...
                                description:
                                    '\u67E5\u8BE2\u7ED3\u679C\u6392\u5E8F,\u4E0D\u586B\u5219\u7EFC\u5408\u6392\u5E8F',
                                enum: t['./modules/content/constants'].PostOrderType,
                            },
                            category: {
                                required: false,
                                type: () => String,
                ...
                [
                    import('./modules/content/dtos/comment.dto'),
                    {
                        QueryCommentDto: {
                            author: {
                                required: false,
                ...
                [
                    import('./modules/content/dtos/tag.dto'),
                    {
                        CreateTagDto: {
                            name: {
                                required: true,
