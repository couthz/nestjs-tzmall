...
import { ShopcartItem } from "@/modules/shopcart/entities/shopcart-item.entity";
...
export class Sku {
  ...
  @Column("bigint", { name: "category_id", comment: "商品分类ID", unsigned: true })
  categoryId: string;
  ...
  @Column("varchar", {
    name: "attr",
    nullable: true,
    comment: "所有销售属性值的json串,sku的属性值组合一定是按照属性名的id从小到大排列的",
    length: 100,
  })
  attr: string;

  @OneToMany(() => ShopcartItem, (ShopcartItem) => ShopcartItem.sku, { cascade: true })
